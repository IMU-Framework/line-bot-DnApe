...
def callback():
    ...
    print(f"Webhook received with body: {body}")  # 新增
    try:
        ...
        print(traceback.format_exc())  # 輸出完整錯誤堆疊
        abort(500)
    return 'OK'
...
def handle_message(event):
    try:
        ...
        try:
            ...
            print(f"Failed to send error message: {reply_e}")
            print(traceback.format_exc())

@app.route('/', methods=['GET'])  # 新增，讓Render健康檢查成功
def index():
